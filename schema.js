...
module.exports.listingSchema = joi.object({
    listing: joi.object({
        ...
        image : joi.object({
            url: joi.string().uri().allow("").default("https://media.cntraveler.com/photos/53da60a46dec627b149e66f4/master/w_1600%2Cc_limit/hilton-moorea-lagoon-resort-spa-moorea-french-poly--110160-1.jpg"),
